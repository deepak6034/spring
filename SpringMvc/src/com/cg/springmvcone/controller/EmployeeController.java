...
public class EmployeeController {
   ...
   List<Employee> empList=employeeservice.showAllEmployee();		
	...
	(@ModelAttribute("aa") Employee emp) {
		...
		Employee empOne=employeeservice.searchEmployee(emp);
		list.add(empOne);
		return new ModelAndView("show","empdata",list);
	...
	public String updateEmployee(@ModelAttribute("up") Employee emp){
	...
	(@ModelAttribute("up") Employee emp, Map<String,Object> model) {
		...
		return new ModelAndView("update","modelupdate",emp);
		
	}
	
	@RequestMapping(value="/updateemployee",method=RequestMethod.POST)
	public String updateEmployeeDataBase(
			@Valid@ModelAttribute("up") Employee emp,
			BindingResult result
			,Map<String,Object> model
			){
